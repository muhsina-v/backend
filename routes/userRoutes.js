...
import { addToCart, getUserCart, removeFromCart, updateUserCart } from "../controllers/user/cartController.js"
...
import { addOrder,cancelOneOrder, getAllOrders, getOneOrder, orderCashOnDelivery, orderWithStripe,StripeSuccess } from '../controllers/user/orderController.js'
...
// order routes
.post("/addOrders", tokenVerify, tryCatch(addOrder))
